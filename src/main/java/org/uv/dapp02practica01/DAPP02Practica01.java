...
public class DAPP02Practica01 {
    ...
    public static void main(String[] args) {
        try {
            ...
            Logger.getLogger(DAPP02Practica01.class.getName()).log(Level.SEVERE, "Error al ejecutar el programa", ex);
    ...
    public static void menu() {
        ...
        do {
            try {
                ...
                step = true;
                Logger.getLogger(DAPP02Practica01.class.getName()).log(Level.SEVERE, null, e);
            }
        } while ((n < 1 || n < 2) || step);
    }
    ...
    public static Venta venta() {
        ...
        venta.setFecha(new java.sql.Date(new java.util.Date().getTime()));
        venta.setTotal(1000);
        for (int i = 0; i < 5;
                i++) {
    ...
    public static Venta getVenta(int id){
        ...
        try {
            ...
            Logger.getLogger(DAPP02Practica01.class.getName()).log(Level.INFO, null, ex);
        }
        return ventatemp;
    ...
    public static void deleteEmploye() {
        ...
        try {
            ...
            Logger.getLogger(DAPP02Practica01.class
